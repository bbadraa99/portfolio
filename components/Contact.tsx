    ...
    <div id='contact' className='h-screen py-10 px-10 center'>
        <div className='center flex-col'>
            ...
            <Link href="https://www.linkedin.com/in/badraa-bat-ulzii-5b5b98187/" target='_blank'>
              <button className="btn btn-md lg:btn-lg bg-transparent hover:bg-stone-100 hover:bg-opacity-40 hover:scale-125 hover:border-2 hover:border-white text-white regular-16 font-dmono border-white">Hire me</button>        
            </Link>
        </div>
    </div>
  )
