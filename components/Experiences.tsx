    ...
    <div id="experiences" className=' w-full xl:w-3/4 2xl:w-[1200px] mx-auto py-20'>
      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        <li>
          ...
          <Link href="https://pal.unist.ac.kr/" target='_blank' className={`timeline-start md:text-end mb-10 p-2 cursor-pointer font-mono ${hoveredExperience !== 1 && hoveredExperience !== null ? 'opacity-50' : ''} ${hoveredExperience === 1  ? 'bg-stone-200 bg-opacity-20 rounded-md' : ''}`}
        ...
        <li >
          ...
          <Link href="https://www.carcare.mn/" target='_blank' className={`timeline-end mb-10 p-2 cursor-pointer font-mono ${hoveredExperience !== 2 && hoveredExperience !== null ? 'opacity-50' : ''} ${hoveredExperience === 2  ? 'bg-stone-200 bg-opacity-20 rounded-md' : ''}`}
        ...
        <li>
          ...
          <Link href="https://digitalsolutions.mn/#slide01" target='_blank' className={`timeline-start md:text-end mb-10 p-2 cursor-pointer font-mono ${hoveredExperience !== 3 && hoveredExperience !== null ? 'opacity-50' : ''} ${hoveredExperience === 3  ? 'bg-stone-200 bg-opacity-20 rounded-md' : ''}`}
