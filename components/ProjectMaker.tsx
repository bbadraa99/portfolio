...
const ProjectMaker = (props: { name: any; description: any; path: any; href: any; }) => {
  ...
  return (
    <div className="card card-compact w-full sm:w-[500px]  border-2 border-transparent hover:border-white bg-slate-400 bg-opacity-30 hover:text-blue-10 rounded-sm">
      <figure>
        <Image
          src={path}
          alt={name}
